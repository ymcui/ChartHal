...
def generate_resp_internvl25(model_id: str, eval_data: dict):
    ...
    for i in tqdm(range(0, len(input_data_list)), ncols=100):
        ...
        generation_args = {"max_new_tokens": 1024, "do_sample": False}
        response = model.chat(tokenizer, pixel_values, input_prompt, generation_args)
